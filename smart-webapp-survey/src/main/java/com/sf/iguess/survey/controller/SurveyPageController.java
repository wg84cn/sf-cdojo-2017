...
public class SurveyPageController {
	...
	@ResponseBody
	public JsonResult questionsView(@RequestParam(value = "surveyType", required = true) Integer surveyType) {
		return new JsonResult(ResponseCode.SUCCESS, "", questionService.findBySurveyType(surveyType));
	}
}
